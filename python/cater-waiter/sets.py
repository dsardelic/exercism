...
def check_drinks(drink_name, drink_ingredients):
    ...
    return (
        f"{drink_name} "
        f"{'Cocktail' if set(drink_ingredients) & ALCOHOLS else 'Mocktail'}"
    )
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category_index = [
        dish_ingredients <= globals()[category] for category in categories
    ].index(True)
    return f"{dish_name}: {categories[category_index]}"
